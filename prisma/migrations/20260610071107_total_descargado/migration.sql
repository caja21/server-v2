...
INSERT INTO "new_CuentaBancaria" ("alias", "billetera", "cbu", "createdAt", "estado", "id", "nombre", "oficina", "operadorId", "saldoBase") SELECT "alias", "billetera", "cbu", "createdAt", "estado", "id", "nombre", "oficina", "operadorId", "saldoBase" FROM "CuentaBancaria";
